...
class Comments {
  ...
  String comment(int temperature, String weather, double windSpeed, double huminity){
  ...
  String commentForClearDays(int temperature, String weather, double windSpeed, double huminity){
      if(number == 0){
  ...
  String commentForCloudsDays(int temperature, String weather, double windSpeed, double huminity){
      if(number == 0){
  ...
  String commentForRainDays(int temperature, String weather, double windSpeed, double huminity){
      if(number == 0){
  ...
  String commentForSnowDays(int temperature, String weather, double windSpeed, double huminity){
      if(number == 0){
